...
#the emails associated with all of your microsoft accounts
emails = ['email1@example1.com', 'email2@example2.com']
...
for email in emails:
    with Browser('chrome') as b:
        ...
        b.fill("loginfmt", email)
        #change myPassword to your actual password
        b.fill("passwd", "myPassword")
